...
NH_METAS_PY			= $(NH_METAS_PY_PROG) $(NH_METAS_PY_ARGS)
NH_METAS_PY_CODE		= $(NH_METAS_PY_PROG) $(NH_METAS_PY_CODE_ARGS)
...
NH_FONT_TTF			= $(DISTDIR)/ttf/$(NH_PS_FONT_FAMILY).ttf
NH_CODING_FONT_TTF		= $(DISTDIR)/ttf/$(NH_PS_CODE_FONT_FAMILY).ttf
NH_THIN_FONT_TTF		= $(DISTDIR)/ttf/$(NH_PS_FONT_FAMILY)-Thin.ttf
NH_THIN_CODING_FONT_TTF		= $(DISTDIR)/ttf/$(NH_PS_CODE_FONT_FAMILY)-Thin.ttf
NH_LIGHT_FONT_TTF		= $(DISTDIR)/ttf/$(NH_PS_FONT_FAMILY)-Light.ttf
NH_LIGHT_CODING_FONT_TTF	= $(DISTDIR)/ttf/$(NH_PS_CODE_FONT_FAMILY)-Light.ttf
NH_FONT_COMP_TTF		= $(DISTDIR)/ttf/$(NH_PS_FONT_FAMILY)Comp.ttf
NH_CODING_FONT_COMP_TTF		= $(DISTDIR)/ttf/$(NH_PS_CODE_FONT_FAMILY)Comp.ttf
NH_THIN_FONT_COMP_TTF		= $(DISTDIR)/ttf/$(NH_PS_FONT_FAMILY)Comp-Thin.ttf
NH_THIN_CODING_FONT_COMP_TTF	= $(DISTDIR)/ttf/$(NH_PS_CODE_FONT_FAMILY)Comp-Thin.ttf
NH_LIGHT_FONT_COMP_TTF		= $(DISTDIR)/ttf/$(NH_PS_FONT_FAMILY)Comp-Light.ttf
NH_LIGHT_CODING_FONT_COMP_TTF	= $(DISTDIR)/ttf/$(NH_PS_CODE_FONT_FAMILY)Comp-Light.ttf
NH_FONT_COND_TTF		= $(DISTDIR)/ttf/$(NH_PS_FONT_FAMILY)Cond.ttf
NH_CODING_FONT_COND_TTF		= $(DISTDIR)/ttf/$(NH_PS_CODE_FONT_FAMILY)Cond.ttf
NH_THIN_FONT_COND_TTF		= $(DISTDIR)/ttf/$(NH_PS_FONT_FAMILY)Cond-Thin.ttf
NH_THIN_CODING_FONT_COND_TTF	= $(DISTDIR)/ttf/$(NH_PS_CODE_FONT_FAMILY)Cond-Thin.ttf
NH_LIGHT_FONT_COND_TTF		= $(DISTDIR)/ttf/$(NH_PS_FONT_FAMILY)Cond-Light.ttf
NH_LIGHT_CODING_FONT_COND_TTF	= $(DISTDIR)/ttf/$(NH_PS_CODE_FONT_FAMILY)Cond-Light.ttf
...
testfonts: FORCE
	$(eval BUILD_NR = $(shell $(SUPPORT_BIN)/buildnr.py))
