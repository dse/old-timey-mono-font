...
HINTED_FONTS = \
	...
	$(OTMONO_COMP_THIN_TTF) 	\
	$(OTCODE_COMP_THIN_TTF) 	\
	$(OTMONO_COND_TTF)		\
	$(OTCODE_COND_TTF)		\
	$(OTMONO_COND_LIGHT_TTF) 	\
	$(OTCODE_COND_LIGHT_TTF)	\
	$(OTMONO_COND_THIN_TTF) 	\
	$(OTCODE_COND_THIN_TTF)
...
UNHINTED_FONTS = \
	...
	$(NH_OTMONO_COMP_THIN_TTF) 	\
	$(NH_OTCODE_COMP_THIN_TTF) 	\
	$(NH_OTMONO_COND_TTF) 		\
	$(NH_OTCODE_COND_TTF) 		\
	$(NH_OTMONO_COND_LIGHT_TTF) 	\
	$(NH_OTCODE_COND_LIGHT_TTF)	\
	$(NH_OTMONO_COND_THIN_TTF) 	\
	$(NH_OTCODE_COND_THIN_TTF)
