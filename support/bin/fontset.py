...
def main():
    ...
    parser.add_argument("--create", action="store_true", help="create font if it doesn't exist")
    ...
    parser.add_argument("--version", help="e.g., \"0.9.0\", \"1.4.2\"")
    parser.add_argument("--sfnt-revision", "--sfntrevision", type=float, help="e.g., 0.0900, 1.0402")
    parser.add_argument("--italic-angle", "--italicangle", type=float, help="counterclockwise angle, typical for italic fonts is -12")
