...
def main():
    ...
    parser.add_argument('--ps-version', '--version', type=str, metavar='VERSION', help='a string containing the actual version number, e.g., "0.9.2", "9.2.0-beta", etc.')
    ...
    if args.ps_version is not None:
        ...
        font.appendSFNTName("English (US)", "Version", args.ps_version)
