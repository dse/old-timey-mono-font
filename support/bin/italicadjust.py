...
def do_italic_shift(glyph, italic_shift_type):
    ...
    for ref in glyph.references:
        ...
        if is_italicizable_mark(ref_glyph):
            ...
            shift_x = (mark_y_center - base_y_center) * math.tan(-glyph.font.italicangle * math.pi / 180)
...
def is_italicizable_mark(glyph):
    return glyph.temporary["norm_codepoint"] in range(0x0300, 0x0370)
